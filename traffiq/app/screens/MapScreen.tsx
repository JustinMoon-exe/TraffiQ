...
import {
  View,
  Text,
  // TextInput, // Removed as address inputs are now Text
  StyleSheet,
  ActivityIndicator,
  TouchableOpacity,
  Alert,
...
import { RootStackParamList, Coordinates } from '../types'; // Adjust path if needed
...
// --- API Key ---
const API_KEY = "AIzaSyBrsklzWqQijkHVivtGeYLUaXdXKVO6XIw"; // Included as requested
...
const MapScreen = () => {
  ...
  useEffect(() => { // Loading state effect...
      ...
      <SafeAreaView style={styles.safeAreaContent}>
        <View style={styles.container}>
          ...
          {/* Bottom Buttons Container */}
           ...
           {/* Fallback Go Back if no route shown */}
            {(!initialDestination || !destinationCoords) && startCoords && ( // Show if no destination or destination coords failed, but start is known
...
// --- Styles (with corrected bottom button base) ---
const styles = StyleSheet.create({
    ...
    bottomButtonBase: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, paddingHorizontal: 10, // Adjusted padding
    borderRadius: 25, // Capsule shape
    marginHorizontal: 4, // Space between buttons
    minHeight: 46, elevation: 2, flexShrink: 1 }, // Allow shrinking
    bottomButtonText: { fontSize: 14, color: '#FFFFFF', fontWeight: '600', marginLeft: 6, },
    goBackButton: { backgroundColor: 'rgba(0, 0, 0, 0.2)', flex: 1 }, // Assign flex value slightly less than 1
    startNavigationButton: { backgroundColor: '#4CAF50', flex: 1 }, // Assign flex value slightly more than 1
    saveRouteButton: { backgroundColor: 'rgba(255, 255, 255, 0.3)', flex: 1 }, // Assign flex value of 1
